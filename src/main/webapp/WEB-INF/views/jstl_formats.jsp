...
<html lang="en">
  ...
  <body>
    ...
    <div>234124.12 --> 234,124.12 2023.01.16 10:18.50 --> 2023 1 16,</div>
    <hr />
    ...
    <div>
      date and time : <fmt:formatDate value="${date_first}" type="both" />
    </div>
    ...
    <div>
      나라 :
      <fmt:setLocale value="ja-JP" scope="session" /> <%=response.getLocale() %>
    </div>
    <div>통화 : <fmt:formatNumber value="${num_third}" type="currency" /></div>
    <div>날짜 : <fmt:formatDate value="${date_third}" type="both" /></div>
